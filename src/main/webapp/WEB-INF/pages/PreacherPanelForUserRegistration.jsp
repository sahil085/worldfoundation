        ...
        <div class="col-md-12">
            <div class="box-for overflow">
                <div class="col-md-12 col-xs-12 register-blocks">
                    <h2>New account : </h2>
                    <form action="/registrationprocessForIyf" id="iyfuserregistrationform" method="post" autocomplete="off" data-toggle="validator">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-sm" id="lname" name="lastName" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="emailToRegister" name="email" required>
                        </div>
                        <div class="form-group">
                            <label for="passworToRegister">Password</label>
                            <input type="password" class="form-control" id="passworToRegister" name="password" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select  required id="admin" class="selectpicker show-tick form-control" name="adminType">
                        ...
                        <div class="form-group">
                            <div class="radio">
                                <label>Deeksha</label><br>
                                <label>
                                    <input type="radio" value="Yes" name="deeksha" required>
                                    Yes
                                </label>
                            </div>
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" value="No" name="deeksha" required>
                                    No
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Number Of Rounds Chant</label>
                            <input  required type="number" placeholder="4" name="roundsChanting">
                        </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#iyfuserregistrationform').ajaxForm({
