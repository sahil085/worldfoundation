                    ...
                    <div class="col-sm-6 col-md-3 p0">
                        <div class="box-two proerty-item">
                            ...
                            <div class="item-entry overflow">
                                ...
                                <span class="center"><h5><a href="/OnlineBookStore"> Order Books Online </a></h5></span>
                                <%--<p style="display: none;">Suspendisse ultricies Suspendisse ultricies Nulla quis dapibus nisl. Suspendisse ultricies commodo arcu nec pretium ...</p>--%>
                                <div class="property-icon">
                                    <button class="btn btn-primary"><span style="color: black">Buy Now</span></button>
                                    <button class="btn btn-primary"><span style="color: black">Add To Cart</span></button>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6 col-md-3 p0">
                        <div class="box-two proerty-item">
                            ...
                            <div class="item-entry overflow">
                                ...
                                <span class="center"><h5><a href="##"> Organize Book Distribution </a></h5></span>
                    ...
                    <div class="col-sm-6 col-md-3 p0">
                        <div class="box-two proerty-item">
                            ...
                            <div class="item-entry overflow">
                                ...
                                <span class="center"><h5><a href="/RegularBookDistributionIndex"> Become A Regular Book Distributor </a></h5></span>
                                <%--<span class="proerty-price pull-right"> $ 300,000</span>--%>
                                <%--<p style="display: none;">Suspendisse ultricies Suspendisse ultricies Nulla quis dapibus nisl. Suspendisse ultricies commodo arcu nec pretium ...</p>--%>
                                <%--<div class="property-icon">--%>
                                <%--<img src="assets/img/icon/bed.png">(5)|--%>
                    ...
                    <div class="col-sm-6 col-md-3 p0">
                        <div class="box-two proerty-item">
                            ...
                            <div class="item-entry overflow">
                                ...
                                <span class="center"><h5><a href="https://s3.amazonaws.com/online.fliphtml5.com/tgzx/dokn/index.html"> Read A Book </a></h5></span>
                                <%--<span class="proerty-price pull-right"> $ 300,000</span>--%>
                                <%--<p style="display: none;">Suspendisse ultricies Suspendisse ultricies Nulla quis dapibus nisl. Suspendisse ultricies commodo arcu nec pretium ...</p>--%>
                                <%--<div class="property-icon">--%>
                                <%--<img src="assets/img/icon/bed.png">(5)|--%>
