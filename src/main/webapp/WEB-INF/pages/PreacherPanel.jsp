    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 col-sm-8  col-xs-12">
                <c:if test="${not empty LiveLectureStatus}">
                    <div class="alert alert-success" id="success-aler">
                        <strong>${LiveLectureStatus}</strong>
                    </div>
                </c:if>
        ...
        <div class="clearfix" >
            ...
            <div class="col-md-12 col-sm-6 single-property-content prp-style-1 ">
                    ...
                    <div class="light-slide-item">
                        <div class="clearfix">
                            ...
                            <ul id="image-gallery" class="gallery list-unstyled cS-hidden">
                                <li data-thumb="/resources/assets/img/ISKCON-youth-Forum.jpg">
                                    <img src="/resources/assets/img/ISKCON-youth-Forum.jpg" width="100%" />
                                </li>
                                <li data-thumb="/resources/assets/img/ISKCON-youth-Forum.jpg">
                                    <img src="/resources/assets/img/ISKCON-youth-Forum.jpg" width="100%"  />
                                </li>
                ...
                <div class="single-property-header col-sm-12"  >
                    <center>
                   <a href="/CreateCoursePage" ><button type="button" class="btn btn-danger pull-left" >Create New Course</button></a>
                   <a href="/CreateLecturePage"> <button type="button" class="btn btn-danger " >Create New Lecture</button></a>
                   <a href="/RegisterUserForIyf" ><button type="button" class="btn btn-danger pull-right" >Register A New User</button>
                   </a>
                    </center>
                </div>

                <div class="single-property-header col-sm-12"  >
                    <a href="/BulkRegistrationPage" class="btn-link">
                ...
                <div class="single-property-wrapper">
                    <div class="single-property-header" >
                        <h2 class="s-property-title pull-left" > Search Courses </h2>
                        <input type="text" id="searchcourse" class="form-control pull-left"  placeholder="Search" >
                        <h2 class="s-property-title pull-left" > Recent Courses </h2>
                    </div>
                    ...
                    <div class="table-responsive table-bordered">
                        ...
                        <table border="1px" class="table tab-content">
                            <thead>
                            <tr>
                                <b>
                                    <th>Course Name</th>
                            ...
                            <tr>
                                ...
                                <td><a href="/UpdateCourseDetailsPage?cname=${i.courseName}" >
                                    <button type="button" class="btn btn-success">Update</button></a>

                                    <button type="button" id="${i.id}"  class=" deletecourse btn btn-danger">Delete</button>
    ...
    <%flag=1;%>
                            ...
                            <c:forEach var="i" items="${upcominglectures}">
                                <tr>
                                    ...
                                    <td><a href="/UpdatelectureinfoPage?lid=${i.id}" >
                                        ...
                                        <a href="/PreacherPanelSingleLecture?lname=${i.tittle}" >
                    ...
                    <center>
                        <div class="single-property-header" >
                            ...
                            <h2 class="s-property-title" >No Upcoming Lecture..!!</h2>
                        </div>
<%
                    }
...
<hr>
                    ...
                    <c:if test="${fn:length(LecturesList) gt 0}">
                        <%flag=1;%>
                        <div class="single-property-header" >

                            <h2 class="s-property-title" > Recent Created lectures </h2>
                        </div>
                        <div class="table-responsive table-bordered">
                                <%--<h1 class="property-price pull-left"> Recent HarinaamSankirtan Nearby You</h1>--%>
                                <%--<span class="property-tittle pull-right">Total Number Of kirtans<br>30</span>--%>
                            <table border="1px" class="table text-center" >
                                ...
                                <tbody>
                                <c:forEach var="i" items="${LecturesList}">
                                    <tr>
                                        <td>${i.tittle}</td>
                                        <td>${i.speakerName}</td>
                                        <td>${i.createCourse.courseName}</td>
                    ...
                    <center>
                        <div class="single-property-header" >
                            ...
                            <h2 class="s-property-title" >No Lecture Yet...! <br><hr> Start Creating Lecture </h2>
                        </div>
...
<%--<html>--%>
<%--<body>--%>
<%--<a href="/CreateCoursePage">Create a New Course</a><br>--%>
<%--<a href="/CreateLecturePage">create lecture</a><br>--%>
<%--${updateLectureInfo}--%>
<%--<h2>--%>
    <%--all lectures--%>
        ...
        <%--<table class="table isSearch" cellspacing="0">--%>
            ...
            <%--<tr class="table-heads ">--%>
                <%--<th class="head-item mbr-fonts-style display-7">Lecture Ttittle</th>--%>
                <%--<th class="head-item mbr-fonts-style display-7">Lecture Desc</th>--%>
                <%--<th class="head-item mbr-fonts-style display-7">Created By</th>--%>
                <%--<th class="head-item mbr-fonts-style display-7">Speaker Name</th>--%>
                <%--<th class="head-item mbr-fonts-style display-7">Course name</th>--%>
                <%--<th class="head-item mbr-fonts-style display-7">Vedic Level</th>--%>
                <%--<th class="head-item mbr-fonts-style display-7">Venue</th>--%>
                <%--<th class="head-item mbr-fonts-style display-7">Street</th>--%>
                <%--<th class="head-item mbr-fonts-style display-7">hangout Url</th>--%>
                <%--<th class="head-item mbr-fonts-style display-7">Youtube Url</th>--%>
            ...
            <%--<tr>--%>
                ...
                <%--<td>${lecture.createdBy.userName}</td>--%>
                <%--<td>${lecture.speakerName}</td>--%>
                <%--<td>${lecture.createCourse.courseName}</td>--%>
                <%--<td>${lecture.createCourse.courseCategory}</td>--%>
                <%--<td>${lecture.venue}</td>--%>
                <%--<td>${lecture.street}</td>--%>
                <%--<td>${lecture.hangoutUrl}</td>--%>
                <%--<td>${lecture.youtubeurl}</td>--%>
                <%--<td>${lecture.date}</td>--%>
                <%--<td>${lecture.time}</td>--%>
                <%--<td><a href="/UpdatelectureinfoPage?lid=${lecture.id}">Update</a> </td>--%>
                <%--<br>--%>
                <%--<td>--%>
                    <%--<form id="sethang" action="/setHangoutUrl" method="post">Hangourt Url :--%>
                    <%--<input type="text" id="hurl" name="url">--%>
                        <%--<input type="number" value="${lecture.id}" name="lid" hidden>--%>
                ...
                <%--</td>--%>
                <%--<td>--%>
                <%--<form id="setwhite" action="/SetWhiteBoardUrl" method="post">--%>
                <%--WhiteBoard url :--%>
                    <%--<input type="text" id="wurl" name="url">--%>
                    <%--<input type="number" value="${lecture.id}" name="lid" hidden>--%>
                    <%--<input type="hidden" name="${_csrf.parameterName}"  value="${_csrf.token}" />--%>
...
<%--<form:form method="post" action="${urlaction}" modelAttribute="UserRegistraion">--%>
    <%--<table>--%>
        <%--<tr>--%>
            <%--<th>User Name</th>--%>
            <%--<th>Firt Name</th  >--%>
        ...
        <%--<c:forEach var="i" items="${UserRegistraion.user}">--%>
            ...
            <%--<tr>--%>
                <%--<td><input name="user[<%=index%>].userName" /></td>--%>
                <%--<td><input name="user[<%=index%>].firstName" /></td>--%>
                <%--<td><input name="user[<%=index%>].lastName" /></td>--%>
                <%--<td><input name="user[<%=index%>].email" /></td>--%>
                <%--<td><input name="user[<%=index%>].password" /></td>--%>
                <%--<td><input name="user[<%=index%>].mobileNumber" /></td>--%>
                <%--<td><input name="user[<%=index%>].address" /></td>--%>
                <%--<td>--%>
                    <%--<select  required id="admin" class="selectpicker show-tick form-control" name="user[<%=index%>].adminType">--%>
                        <%--<option value="Harinaam Sankirtan">Harinaam Sankirtan</option>--%>
                        <%--<option value="Preaching">Preacher</option>--%>
                        <%--<option value="USER">User</option>--%>
                        <%--<option value="book distribution admin">book distribution admin</option>--%>
                    <%--</select>--%>
                <%--</td>--%>
                <%--<td><input name="user[<%=index%>].state" /></td>--%>
                <%--<td><input name="user[<%=index%>].deeksha"/></td>--%>
                <%--<td><input name="user[<%=index%>].roundsChanting"/></td>--%>
