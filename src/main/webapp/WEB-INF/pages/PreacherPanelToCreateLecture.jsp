        ...
        <div class="col-md-12">
            <div class="box-for overflow">
                <div class="col-md-12 col-xs-12 register-blocks">
                    <h2>create your lecture : </h2>
                    ${createlecturemsg} <a href="/logout">logout</a>
                    <form action="/CreateLectureProcess" method="post" autocomplete="off" data-toggle="validator">
                        <div class="form-group">
                            <label for="fname">Tittle</label>
                            <input type="text" class="form-control" id="fname" name="Tittle" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="lname" name="Description" required></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="date" id="dtp_input2" value="" class="hidden" /><br/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="col-sm-3">
                                ...
                                <div class="form-group">
                                    <input id="timepicker1" type="time" name="Time" class="form-control input-small">
