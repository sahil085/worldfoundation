                            ...
                            <div class="yamm-content">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <ul>
                                            <li><a href="/harinaamsankirtanpage">Harinaam Sankirtan</a> </li>
            ...
            <div class="col-md-8 single-property-content prp-style-1 ">
                ...
                <div class="single-property-wrapper">
                    <div class="single-property-header">
                        <!-- <h4 class="s-property-title"> Recent HarinaamSankirtan Nearby You </h4>                                         -->
                    ...
                    <div class="dealer-widget">
                        <div class="dealer-content">
                            <div class="inner-wrapper">
                                ...
                                <div class="clear">
                                    <a href="/harinaamsankirtanbookingpage" class="btn btn-default" role="button"  style="margin-top: 4px;margin-left: 150px;border-color: white;background-color: black;color: white;">Book Now</a>
                                    <!--   <button type="button" class="btn btn-default" onclick="changeVideo('e80BbX05D7Y')">Raj Nagar</button> -->
                                </div>
                            ...
                            <ul>
                                <li>
                                    <div class="col-md-3 col-sm-3 col-xs-3 blg-thumb p0">
                                        <a href="single.html"><img src="/resources/assets/img/demo/small-property-2.jpg"></a>
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-8 blg-entry">
                                        <h6> <a href="single.html">Hare Krishna </a></h6>
                                        <span class="property-price">3000000$</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="col-md-3 col-sm-3  col-xs-3 blg-thumb p0">
                                        <a href="single.html"><img src="/resources/assets/img/demo/small-property-1.jpg"></a>
                                        <span class="property-seeker">
                                                    <b class="b-1">A</b>
                                                    <b class="b-2">S</b>
                                                </span>
                                ...
                                <li>
                                    <div class="col-md-3 col-sm-3 col-xs-3 blg-thumb p0">
                                        <a href="single.html"><img src="/resources/assets/img/demo/small-property-3.jpg"></a>
                                        <span class="property-seeker">
                                                    <b class="b-1">A</b>
                                                    <b class="b-2">S</b>
                                                </span>
