...
<div class="register-area" style="background-color: rgb(249, 249, 249);">
    <div class="container">
        ...
        <div class="col-md-12">
            <c:if test="${fn:length(lecturedetails) >0}">
            <%
                flag=1;
            %>
            <div class="box-for overflow">
                <div class="col-md-12 col-xs-12 register-blocks">
                    ...
                    ${L} <a href="/logout">logout</a>
                    <c:forEach var="l" items="${lecturedetails}">
                    <form action="/UpdateLectureInfoProcess" method="post" autocomplete="off" data-toggle="validator">
                        <div class="form-group">
                            <label for="fname">Tittle</label>
                            <input type="text" class="form-control" id="fname" name="Tittle" value="${l.tittle}" required>
                        </div>
                        <div class="form-group">
                            <label for="fname">Course</label>
                            <input type="text" class="form-control" id="coursename" name="CourseName" value="${l.courseName}" required>
                        </div>
                        <div class="form-group">
                            <label for="lname">Description</label>
                            <textarea class="form-control" id="lname" name="Description" value="${l.description}" required></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="date" id="dtp_input2" value="${l.date}" /><br/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="time" name="Time" id="dtp_input3" value="${l.time}" placeholder="HH:MM" required/><br/>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>Venue <small>(locatiion Of Lecture)</small></label>
                                    <input type="text" name="Venue" value="${l.venue}" class="form-control" placeholder="sec-11,  ISKCON CHOWK, R-11/35, Hare Krishna Marg, Block 11, Raj Nagar, Ghaziabad" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>Street</label>
                                    <input type="text" class="form-control" value="${l.street}" id="us3-address" placeholder="Raj Nagar" name="Street" />
