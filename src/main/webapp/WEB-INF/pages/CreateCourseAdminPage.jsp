        ...
        <div class="col-md-6">
            <div class="box-for overflow">
                <div class="col-md-12 col-xs-12 register-blocks">
                    ...
                    ${createcoursemsg} <a href="/logout">logout</a>
                    <form action="/CreateCourseProcess" method="post" autocomplete="off" data-toggle="validator">
                        <div class="form-group">
                            <label for="fname">Course Name</label>
                            <input type="text" class="form-control" id="fname" name="CourseName" required>
                        </div>
                        <div class="form-group">
