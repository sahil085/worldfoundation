        ...
        <div class="col-md-12">
            <div class="box-for overflow">
                <div class="col-md-12 col-xs-12 register-blocks">
                    ...
                    <form id="lectureatcollegeform" action="/LectureRequestForCollegeProcess" method="post" autocomplete="off" data-toggle="validator">
                        <div class="form-group">
                            <label for="fname">Lecture Tittle</label>
                            <input type="text" class="form-control" id="fname" name="LectureTittle" required>
                        </div>
                        <div class="form-group">
                            <label for="fname">Choose Course Name</label>
                            <input type="text" class="form-control" id="coursenameforcollege" name="CourseName" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Select Speaker Name <small>From Whom Do You Want To Listen Lecture</small></label>
                        ...
                        <div class="col-sm-12">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label for="dtp_input3" >Start Time</label>
                                    <input type="time" name="StartTime" id="dtp_input3" value="" placeholder="HH:MM" required/><br/>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label for="dtp_input4" >End Time</label>
                                    <input type="time" name="EndTime" id="dtp_input4" value="" placeholder="HH:MM" required/><br/>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>College Name<small>(locatiion Of Lecture)</small></label>
                                    <input type="text" name="CollegeName" class="form-control" placeholder="sec-11,  ISKCON CHOWK, R-11/35, Hare Krishna Marg, Block 11, Raj Nagar, Ghaziabad" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="us3-address" placeholder="Raj Nagar" name="CollegeAddress" />
...
<script type="text/javascript">
    $(document).ready(function() {
        //attach autocomplete
        $("#coursenameforcollege").autocomplete({
            minLength: 1,
            delay: 500,
            //define callback to format results
            source: function (request, response) {
                $.getJSON("/fetchcoursenameforcollege?${_csrf.parameterName}=${_csrf.token}", request, function(result) {
